...
//go:generate gowrap gen -p github.com/bloxapp/beacon-kit -i Client -t calls.template -o calls.go -l ""
...
func (c *Client) Address() (s1 string) {
	return c.clients[0].Address()
}

func (c *Client) AggregateAttestation(ctx context.Context, slot phase0.Slot, attestationDataRoot phase0.Root) (ap1 *phase0.Attestation, err error) {
...
func (c *Client) AttestationData(ctx context.Context, slot phase0.Slot, committeeIndex phase0.CommitteeIndex) (ap1 *phase0.AttestationData, err error) {
...
func (c *Client) AttesterDuties(ctx context.Context, epoch phase0.Epoch, validatorIndices []phase0.ValidatorIndex) (apa1 []*apiv1.AttesterDuty, err error) {
...
func (c *Client) BeaconBlockHeader(ctx context.Context, blockID string) (bp1 *apiv1.BeaconBlockHeader, err error) {
...
func (c *Client) BeaconBlockProposal(ctx context.Context, slot phase0.Slot, randaoReveal phase0.BLSSignature, graffiti []byte) (vp1 *spec.VersionedBeaconBlock, err error) {
...
func (c *Client) BeaconBlockRoot(ctx context.Context, blockID string) (rp1 *phase0.Root, err error) {
...
func (c *Client) BlindedBeaconBlockProposal(ctx context.Context, slot phase0.Slot, randaoReveal phase0.BLSSignature, graffiti []byte) (vp1 *api.VersionedBlindedBeaconBlock, err error) {
...
func (c *Client) Domain(ctx context.Context, domainType phase0.DomainType, epoch phase0.Epoch) (d1 phase0.Domain, err error) {
...
func (c *Client) GenesisTime(ctx context.Context) (t1 time.Time, err error) {
...
func (c *Client) Name() (s1 string) {
	return c.clients[0].Name()
}

func (c *Client) ProposerDuties(ctx context.Context, epoch phase0.Epoch, validatorIndices []phase0.ValidatorIndex) (ppa1 []*apiv1.ProposerDuty, err error) {
...
func (c *Client) SignedBeaconBlock(ctx context.Context, blockID string) (vp1 *spec.VersionedSignedBeaconBlock, err error) {
...
func (c *Client) Spec(ctx context.Context) (m1 map[string]interface{}, err error) {
...
func (c *Client) SubmitAggregateAttestations(ctx context.Context, aggregateAndProofs []*phase0.SignedAggregateAndProof) (err error) {
...
func (c *Client) SubmitAttestations(ctx context.Context, attestations []*phase0.Attestation) (err error) {
...
func (c *Client) SubmitBeaconBlock(ctx context.Context, block *spec.VersionedSignedBeaconBlock) (err error) {
...
func (c *Client) SubmitBeaconCommitteeSubscriptions(ctx context.Context, subscriptions []*apiv1.BeaconCommitteeSubscription) (err error) {
...
func (c *Client) SubmitBlindedBeaconBlock(ctx context.Context, block *api.VersionedSignedBlindedBeaconBlock) (err error) {
...
func (c *Client) SubmitProposalPreparations(ctx context.Context, preparations []*apiv1.ProposalPreparation) (err error) {
...
func (c *Client) SubmitSyncCommitteeContributions(ctx context.Context, contributionAndProofs []*altair.SignedContributionAndProof) (err error) {
...
func (c *Client) SubmitSyncCommitteeMessages(ctx context.Context, messages []*altair.SyncCommitteeMessage) (err error) {
...
func (c *Client) SubmitSyncCommitteeSubscriptions(ctx context.Context, subscriptions []*apiv1.SyncCommitteeSubscription) (err error) {
...
func (c *Client) SubmitValidatorRegistrations(ctx context.Context, registrations []*api.VersionedSignedValidatorRegistration) (err error) {
...
func (c *Client) SyncCommitteeContribution(ctx context.Context, slot phase0.Slot, subcommitteeIndex uint64, beaconBlockRoot phase0.Root) (sp1 *altair.SyncCommitteeContribution, err error) {
...
func (c *Client) SyncCommitteeDuties(ctx context.Context, epoch phase0.Epoch, validatorIndices []phase0.ValidatorIndex) (spa1 []*apiv1.SyncCommitteeDuty, err error) {
...
func (c *Client) Validators(ctx context.Context, stateID string, validatorIndices []phase0.ValidatorIndex) (m1 map[phase0.ValidatorIndex]*apiv1.Validator, err error) {
...
func (c *Client) ValidatorsByPubKey(ctx context.Context, stateID string, validatorPubKeys []phase0.BLSPubKey) (m1 map[phase0.ValidatorIndex]*apiv1.Validator, err error) {
